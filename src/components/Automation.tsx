  ...
  return (
    <section id="automation" className={cn('py-20 md:py-32 bg-gray-50', className)}>
      <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-3">
              <img 
                ...
                alt="MOSAIC Logo" 
                className="w-64 h-64 md:w-80 md:h-80 object-contain bg-black rounded-2xl p-0.5 shadow-2xl"
              />
            </div>
            ...
            <a 
              ...
              className="inline-flex items-center gap-0.5 bg-navy text-white px-8 py-3 rounded-lg hover:bg-navy/90 transition-colors group/link"
            >
        ...
        {/* Two Main Solutions */}
        <div className="grid lg:grid-cols-2 gap-0.52">
          {/* Local AI Solutions */}
          <FadeIn delay={300}>
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow group">
              <CardContent className="p-8">
                ...
                <div className="bg-gray-100 rounded-lg p-0.5 mb-3">

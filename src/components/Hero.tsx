        ...
        <div className="max-w-3xl">
          <FadeIn delay={200}>
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-medium tracking-tight text-[#1B1F3B] leading-tight mb-6">
                  Sacha Brouck <span className="block text-2xl md:text-3xl mt-2 text-[#2D2D2D]">Data & Analytics Professional</span>
                </h1>
                
                <p className="text-xl md:text-2xl text-[#2D2D2D] font-medium mb-6">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-white/40 backdrop-blur-sm rounded-lg -z-10"></div>

          ...
          <FadeIn delay={200}>
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-6">
              <Avatar className="w-[180px] h-[180px] border-4 border-white shadow-lg transition-transform duration-300 hover:scale-105">
                <AvatarImage src={avatarImage} alt="Sacha Brouck" className="object-cover object-[12%_32%]" />
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-xl shadow-md p-6 mb-8 max-w-3xl">
              <p className="text-lg text-gray-700 leading-relaxed mb-3">
                I design and build end-to-end data and AI systems, from large-scale data collection and signal extraction to modeling, scoring, and deployment.
              </p>

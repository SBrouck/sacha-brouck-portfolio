    ...
    <section id="research" className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mx-auto mb-16">
          <FadeIn>
            <h2 className="text-3xl md:text-4xl font-playfair mb-8 text-center">Research</h2>
          </FadeIn>
                  ...
                  <div className="bg-white p-8 md:p-12">
                    <div className="flex flex-col lg:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 text-center lg:text-left">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 font-playfair">
                        ...
                        <div className="flex flex-wrap gap-2 mb-6 justify-center lg:justify-start">
                          <span className="px-3 py-1 bg-gray-100 border border-terracotta text-xs rounded-full text-terracotta font-semibold">
                            XGBoost
                          </span>
                          <span className="px-3 py-1 bg-gray-100 border border-navy text-xs rounded-full text-navy font-semibold">
                            Causal Inference
                          </span>
                          <span className="px-3 py-1 bg-gray-100 border border-terracotta text-xs rounded-full text-terracotta font-semibold">
                            Real Estate
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <FadeIn delay={200}>
            <Card className="border-0 shadow-sm h-full hover:shadow-md transition-shadow group hover:border-terracotta border border-transparent">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-navy transition-colors font-playfair">Data Scale</h3>
          ...
          <FadeIn delay={250}>
            <Card className="border-0 shadow-sm h-full hover:shadow-md transition-shadow group hover:border-terracotta border border-transparent">
              <CardContent className="p-6 text-center">
                <div className="text-4xl mb-4">🎯</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-navy transition-colors font-playfair">Performance</h3>
                <p className="text-gray-600">
          ...
          <FadeIn delay={300}>
            <Card className="border-0 shadow-sm h-full hover:shadow-md transition-shadow group hover:border-terracotta border border-transparent">
              <CardContent className="p-6 text-center">
                <div className="text-4xl mb-4">🔬</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-navy transition-colors font-playfair">Methodology</h3>
                <p className="text-gray-600">
                  Month-blocked CV<br />
          ...
          <FadeIn delay={350}>
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow group hover:border-terracotta border border-transparent">
              <CardContent className="p-6">
                ...
                />
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-navy transition-colors font-playfair">LOFO Impact Analysis</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow group hover:border-terracotta border border-transparent">
              <CardContent className="p-6">
                <img
                  ...
                  className="w-full h-auto rounded-lg mb-4"
                />
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-navy transition-colors font-playfair">SHAP Feature Importance</h3>
                <p className="text-gray-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <FadeIn delay={450}>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6 font-playfair">Key Findings</h3>
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-lg border-l-4 border-navy">
                  <strong className="text-navy">Broker activity:</strong> Indispensable for prediction
                </div>
                <div className="p-4 bg-gray-50 rounded-lg border-l-4 border-terracotta">
          ...
          <FadeIn delay={500}>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6 font-playfair">Future Directions</h3>
              <div className="space-y-4">
